...
for(const asset of ['hero-hd.webp','hero-studio-4k.webp','product-hd.webp','campaign-hd.webp','cta-hd.webp','avatars-hd.webp','logo.svg','logo-wide.svg'])files['/assets/'+asset]='assets/'+asset;
