...
for(const asset of ['hero-hd.webp','hero-4k.webp','hero-clean-4k.webp','product-hd.webp','campaign-hd.webp','cta-hd.webp','avatars-hd.webp','logo.svg','logo-wide.svg','hero-title.svg','hero-title-white.svg'])files['/assets/'+asset]='assets/'+asset;
